...
type NewsfeedPublishingClient interface {
	...
	UpdateEngagementScore(ctx context.Context, in *UpdateEngagementScoreRequest, opts ...grpc.CallOption) (*UpdateEngagementScoreResponse, error)
}
...
func (c *newsfeedPublishingClient) PublishPost(ctx context.Context, in *PublishPostRequest, opts ...grpc.CallOption) (*PublishPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/newsfeed_publishing.NewsfeedPublishing/PublishPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *newsfeedPublishingClient) UpdateEngagementScore(ctx context.Context, in *UpdateEngagementScoreRequest, opts ...grpc.CallOption) (*UpdateEngagementScoreResponse, error) {
	out := new(UpdateEngagementScoreResponse)
	err := c.cc.Invoke(ctx, "/newsfeed_publishing.NewsfeedPublishing/UpdateEngagementScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NewsfeedPublishingServer interface {
	...
	UpdateEngagementScore(context.Context, *UpdateEngagementScoreRequest) (*UpdateEngagementScoreResponse, error)
...
func (UnimplementedNewsfeedPublishingServer) UpdateEngagementScore(context.Context, *UpdateEngagementScoreRequest) (*UpdateEngagementScoreResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEngagementScore not implemented")
}
...
func _NewsfeedPublishing_PublishPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/newsfeed_publishing.NewsfeedPublishing/PublishPost",
	}
...
func _NewsfeedPublishing_UpdateEngagementScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateEngagementScoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NewsfeedPublishingServer).UpdateEngagementScore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/newsfeed_publishing.NewsfeedPublishing/UpdateEngagementScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsfeedPublishingServer).UpdateEngagementScore(ctx, req.(*UpdateEngagementScoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NewsfeedPublishing_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateEngagementScore",
			Handler:    _NewsfeedPublishing_UpdateEngagementScore_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/types/proto/newsfeed_publishing.proto",
}
