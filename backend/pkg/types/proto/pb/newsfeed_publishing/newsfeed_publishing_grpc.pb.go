...
func (c *newsfeedPublishingClient) PublishPost(ctx context.Context, in *PublishPostRequest, opts ...grpc.CallOption) (*PublishPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, NewsfeedPublishing_PublishPost_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNewsfeedPublishingServer must be embedded to have
...
func (UnimplementedNewsfeedPublishingServer) testEmbeddedByValue()                            {}
...
func RegisterNewsfeedPublishingServer(s grpc.ServiceRegistrar, srv NewsfeedPublishingServer) {
	// If the following call pancis, it indicates UnimplementedNewsfeedPublishingServer was
